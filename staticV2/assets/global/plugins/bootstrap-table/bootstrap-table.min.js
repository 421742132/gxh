...
function(t) {
    ...
    n = function(i) {
        ...
        for (e = 0; e < i.length; e++) for (a[e] = [], o = 0; n > o; o++) a[e][o] = !1;
        for (e = 0; e < i.length; e++) for (o = 0; o < i[e].length; o++) {
            var r = i[e][o],
            h = r.rowspan || 1,
            l = r.colspan || 1,
            p = t.inArray(!1, a[e]);
    ...
    h = function(i, e, o) {
        ...
        for (var r = 0; r < s.length; r++) if (a = s[r], t.inArray(a, n) > -1 && i[a] !== e[a]) return ! 1;
        return ! 0
    },
    l = function(t) {
    ...
    d = function(t, i) {
        var e = t;
        if ("string" != typeof i || t.hasOwnProperty(i)) return t[i];
        var o = i.split(".");
        for (var s in o) e = e[o[s]];
        return e
    },
    f = function(i, e) {
        this.options = e,
    ...
    t.extend(f.DEFAULTS, f.LOCALES["en-US"]),
    f.COLUMN_DEFAULTS = {
        radio: !1,
        checkbox: !1,
        checkboxEnabled: !0,
    ...
    f.prototype.initLocale = function() {
        if (this.options.locale) {
            ...
            i[0].toLowerCase(),
            i[1] && i[1].toUpperCase(),
            t.fn.bootstrapTable.locales[this.options.locale] ? t.extend(this.options, t.fn.bootstrapTable.locales[this.options.locale]) : t.fn.bootstrapTable.locales[i.join("-")] ? t.extend(this.options, t.fn.bootstrapTable.locales[i.join("-")]) : t.fn.bootstrapTable.locales[i[0]] && t.extend(this.options, t.fn.bootstrapTable.locales[i[0]])
        }
    },
    f.prototype.initContainer = function() {
        ...
        -1 !== t.inArray("table-no-bordered", this.options.classes.split(" ")) && this.$tableContainer.addClass("table-no-bordered")
    },
    f.prototype.initTable = function() {
        ...
        this.$header.length || (this.$header = t("<thead></thead>").appendTo(this.$el)),
        ...
        t.isArray(this.options.columns[0]) || (this.options.columns = [this.options.columns]),
        this.options.columns = t.extend(!0, [], e, this.options.columns),
        this.columns = [],
        n(this.options.columns),
        t.each(this.options.columns,
        function(e, o) {
            t.each(o,
            function(o, s) {
                s = t.extend({},
                f.COLUMN_DEFAULTS, s),
                "undefined" != typeof s.fieldIndex && (i.columns[s.fieldIndex] = s),
                i.options.columns[e][o] = s
            })
        }),
        this.options.data.length || (this.$el.find(">tbody>tr").each(function() {
            var e = {};
            e._id = t(this).attr("id"),
            e._class = t(this).attr("class"),
            e._data = c(t(this).data()),
            t(this).find("td").each(function(o) {
                var s = i.columns[o].field;
                e[s] = t(this).html(),
                e["_" + s + "_id"] = t(this).attr("id"),
                e["_" + s + "_class"] = t(this).attr("class"),
                e["_" + s + "_rowspan"] = t(this).attr("rowspan"),
                e["_" + s + "_title"] = t(this).attr("title"),
                e["_" + s + "_data"] = c(t(this).data())
            }),
            o.push(e)
        }), this.options.data = o)
    },
    f.prototype.initHeader = function() {
        ...
        function(n, a) {
            s.push("<tr>"),
            0 == n && !i.options.cardView && i.options.detailView && s.push(e('<th class="detail" rowspan="%s"><div class="fht-cell"></div></th>', i.options.columns.length)),
            t.each(a,
            function(t, n) {
                var a = "",
                r = "",
                ...
                if (void 0 === n.width || i.options.cardView || "string" == typeof n.width && -1 !== n.width.indexOf("%") && (c = "%"), n.width && "string" == typeof n.width && (d = n.width.replace("%", "").replace("px", "")), r = e("text-align: %s; ", n.halign ? n.halign: n.align), h = e("text-align: %s; ", n.align), l = e("vertical-align: %s; ", n.valign), l += e("width: %s; ", !n.checkbox && !n.radio || d ? d ? d + c: void 0 : "36px"), "undefined" != typeof n.fieldIndex) {
                    if (i.header.fields[n.fieldIndex] = n.field, i.header.styles[n.fieldIndex] = h + l, i.header.classes[n.fieldIndex] = p, i.header.formatters[n.fieldIndex] = n.formatter, i.header.events[n.fieldIndex] = n.events, i.header.sorters[n.fieldIndex] = n.sorter, i.header.sortNames[n.fieldIndex] = n.sortName, i.header.cellStyles[n.fieldIndex] = n.cellStyle, i.header.searchables[n.fieldIndex] = n.searchable, !n.visible) return;
                    if (i.options.cardView && !n.cardVisible) return;
                    o[n.field] = n
                }
                s.push("<th" + e(' title="%s"', n.titleTooltip), n.checkbox || n.radio ? e(' class="bs-checkbox %s"', n["class"] || "") : p, e(' style="%s"', r + l), e(' rowspan="%s"', n.rowspan), e(' colspan="%s"', n.colspan), e(' data-field="%s"', n.field), "tabindex='0'", ">"),
                s.push(e('<div class="th-inner %s">', i.options.sortable && n.sortable ? "sortable both": "")),
                a = n.title,
                n.checkbox && (!i.options.singleSelect && i.options.checkboxHeader && (a = '<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline"><input name="btSelectAll" type="checkbox" /><span></span></label>'), i.header.stateField = n.field),
                n.radio && (a = "", i.header.stateField = n.field, i.options.singleSelect = !0),
                s.push(a),
                s.push("</div>"),
    ...
    f.prototype.initFooter = function() { ! this.options.showFooter || this.options.cardView ? this.$tableFooter.hide() : this.$tableFooter.show()
    },
    f.prototype.initData = function(t, i) {
        "append" === i ? this.data = this.data.concat(t) : "prepend" === i ? this.data = [].concat(t).concat(this.data) : this.data = t || this.options.data,
        "append" === i ? this.options.data = this.options.data.concat(t) : "prepend" === i ? this.options.data = [].concat(t).concat(this.options.data) : this.options.data = this.data,
    ...
    f.prototype.onSort = function(i) {
        ...
        this.options.sortName === e.data("field") ? this.options.sortOrder = "asc" === this.options.sortOrder ? "desc": "asc": (this.options.sortName = e.data("field"), this.options.sortOrder = "asc" === e.data("order") ? "desc": "asc"),
    ...
    f.prototype.initToolbar = function() {
        ...
        l = 0;
        this.$toolbar.html(""),
        ("string" == typeof this.options.toolbar || "object" == typeof this.options.toolbar) && t(e('<div class="bars pull-%s"></div>', this.options.toolbarAlign)).appendTo(this.$toolbar).append(t(this.options.toolbar)),
        a = [e('<div class="columns columns-%s btn-group pull-%s">', this.options.buttonsAlign, this.options.buttonsAlign)],
        "string" == typeof this.options.icons && (this.options.icons = r(null, this.options.icons)),
        this.options.showPaginationSwitch && a.push(e('<button class="btn btn-default" type="button" name="paginationSwitch" title="%s">', this.options.formatPaginationSwitch()), e('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.paginationSwitchDown), "</button>"),
        this.options.showRefresh && a.push(e('<button class="btn btn-default' + e(" btn-%s", this.options.iconSize) + '" type="button" name="refresh" title="%s">', this.options.formatRefresh()), e('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.refresh), "</button>"),
        this.options.showToggle && a.push(e('<button class="btn btn-default' + e(" btn-%s", this.options.iconSize) + '" type="button" name="toggle" title="%s">', this.options.formatToggle()), e('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.toggle), "</button>"),
        this.options.showColumns && (a.push(e('<div class="keep-open btn-group" title="%s">', this.options.formatColumns()), '<button type="button" class="btn btn-default' + e(" btn-%s", this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">', e('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.columns), ' <span class="caret"></span>', "</button>", '<ul class="dropdown-menu" role="menu">'), t.each(this.columns,
        function(t, i) {
            if (!i.radio && !i.checkbox && (!n.options.cardView || i.cardVisible)) {
                var o = i.visible ? ' checked="checked"': "";
                i.switchable && (a.push(e('<li><label class="mt-checkbox mt-checkbox-outline"><input type="checkbox" data-field="%s" value="%s"%s> %s<span></span></label></li>', i.field, t, o, i.title)), l++)
            }
        }), a.push("</ul>", "</div>")),
        a.push("</div>"),
        (this.showToolbar || a.length > 2) && this.$toolbar.append(a.join("")),
        this.options.showPaginationSwitch && this.$toolbar.find('button[name="paginationSwitch"]').off("click").on("click", t.proxy(this.togglePagination, this)),
        this.options.showRefresh && this.$toolbar.find('button[name="refresh"]').off("click").on("click", t.proxy(this.refresh, this)),
        this.options.showToggle && this.$toolbar.find('button[name="toggle"]').off("click").on("click",
        function() {
            n.toggleView()
        }),
        this.options.showColumns && (i = this.$toolbar.find(".keep-open"), l <= this.options.minimumCountColumns && i.find("input").prop("disabled", !0), i.find("li").off("click").on("click",
        function(t) {
            t.stopImmediatePropagation()
        }), i.find("input").off("click").on("click",
        function() {
            var i = t(this);
            n.toggleColumn(s(n.columns, t(this).data("field")), i.prop("checked"), !1),
            n.trigger("column-switch", t(this).data("field"), i.prop("checked"))
        })),
        this.options.search && (a = [], a.push('<div class="pull-' + this.options.searchAlign + ' search">', e('<input class="form-control' + e(" input-%s", this.options.iconSize) + '" type="text" placeholder="%s">', this.options.formatSearch()), "</div>"), this.$toolbar.append(a.join("")), o = this.$toolbar.find(".search input"), o.off("keyup drop").on("keyup drop",
        function(t) {
            clearTimeout(h),
    ...
    f.prototype.onSearch = function(i) {
        ...
        this.options.trimOnSearch && t(i.currentTarget).val() !== e && t(i.currentTarget).val(e),
        e !== this.searchText && (this.searchText = e, this.options.pageNumber = 1, this.initSearch(), this.updatePagination(), this.trigger("search", e))
    },
    f.prototype.initSearch = function() {
        ...
        if ("server" !== this.options.sidePagination) {
            ...
            this.data = o ? t.grep(this.options.data,
            function(i, e) {
                for (var s in o) if (t.isArray(o[s])) {
                    if ( - 1 === t.inArray(i[s], o[s])) return ! 1
                } else if (i[s] !== o[s]) return ! 1;
                return ! 0
            }) : this.options.data,
            this.data = e ? t.grep(this.data,
            function(o, n) {
                for (var a in o) {
                    ...
                    l && l.searchFormatter && (h = r(l, i.header.formatters[p], [h, o, n], h));
                    var c = t.inArray(a, i.header.fields);
                    if ( - 1 !== c && i.header.searchables[c] && ("string" == typeof h || "number" == typeof h)) if (i.options.strictSearch) {
    ...
    f.prototype.initPagination = function() {
        ...
        if (this.totalPages > 0 && this.options.pageNumber > this.totalPages && (this.options.pageNumber = this.totalPages), this.pageFrom = (this.options.pageNumber - 1) * this.options.pageSize + 1, this.pageTo = this.options.pageNumber * this.options.pageSize, this.pageTo > this.options.totalRows && (this.pageTo = this.options.totalRows), d.push('<div class="pull-' + this.options.paginationDetailHAlign + ' pagination-detail">', '<span class="pagination-info">', this.options.onlyInfoPagination ? this.options.formatDetailPagination(this.options.totalRows) : this.options.formatShowingRows(this.pageFrom, this.pageTo, this.options.totalRows), "</span>"), !this.options.onlyInfoPagination) {
            ...
            var b = [e('<span class="btn-group %s">', "top" === this.options.paginationVAlign || "both" === this.options.paginationVAlign ? "dropdown": "dropup"), '<button type="button" class="btn btn-default ' + e(" btn-%s", this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">', '<span class="page-size">', f ? this.options.formatAllRows() : this.options.pageSize, "</span>", ' <span class="caret"></span>', "</button>", '<ul class="dropdown-menu" role="menu">'],
            ...
            function(t, i) {
                if (!c.options.smartDisplay || 0 === t || m[t - 1] <= c.options.totalRows) {
                    var o;
                    o = f ? i === c.options.formatAllRows() ? ' class="active"': "": i === c.options.pageSize ? ' class="active"': "",
                    b.push(e('<li%s><a href="javascript:void(0)">%s</a></li>', o, i))
                }
            }), b.push("</ul></span>"), d.push(this.options.formatRecordsPerPage(b.join(""))), d.push("</span>"), d.push("</div>", '<div class="pull-' + this.options.paginationHAlign + ' pagination">', '<ul class="pagination' + e(" pagination-%s", this.options.iconSize) + '">', '<li class="page-first"><a href="javascript:void(0)">' + this.options.paginationFirstText + "</a></li>", '<li class="page-pre"><a href="javascript:void(0)">' + this.options.paginationPreText + "</a></li>"), this.totalPages < 5 ? (o = 1, s = this.totalPages) : (o = this.options.pageNumber - 2, s = o + 4, 1 > o && (o = 1, s = 5), s > this.totalPages && (s = this.totalPages, o = s - 4)), i = o; s >= i; i++) d.push('<li class="page-number' + (i === this.options.pageNumber ? " active": "") + '">', '<a href="javascript:void(0)">', i, "</a>", "</li>");
            d.push('<li class="page-next"><a href="javascript:void(0)">' + this.options.paginationNextText + "</a></li>", '<li class="page-last"><a href="javascript:void(0)">' + this.options.paginationLastText + "</a></li>", "</ul>", "</div>")
        }
        this.$pagination.html(d.join("")),
    ...
    f.prototype.onPageListChange = function(i) {
        ...
        this.options.pageSize = e.text().toUpperCase() === this.options.formatAllRows().toUpperCase() ? this.options.formatAllRows() : +e.text(),
    ...
    f.prototype.initBody = function(i) {
        ...
        a = [],
        h = this.getData();
        this.trigger("pre-body", h),
        this.$body = this.$el.find(">tbody"),
        this.$body.length || (this.$body = t("<tbody></tbody>").appendTo(this.$el)),
        this.options.pagination && "server" !== this.options.sidePagination || (this.pageFrom = 1, this.pageTo = h.length);
        for (var p = this.pageFrom - 1; p < this.pageTo; p++) {
            ...
            m = {},
            y = [];
            if (u = r(this.options, this.options.rowStyle, [f, p], u), u && u.css) for (c in u.css) g.push(c + ": " + u.css[c]);
            if (m = r(this.options, this.options.rowAttributes, [f, p], m)) for (c in m) y.push(e('%s="%s"', c, l(m[c])));
            f._data && !t.isEmptyObject(f._data) && t.each(f._data,
            function(t, i) {
                "index" !== t && (b += e(' data-%s="%s"', t, i))
            }),
            a.push("<tr", e(" %s", y.join(" ")), e(' id="%s"', t.isArray(f) ? void 0 : f._id), e(' class="%s"', u.classes || (t.isArray(f) ? void 0 : f._class)), e(' data-index="%s"', p), e(' data-uniqueid="%s"', f[this.options.uniqueId]), e("%s", b), ">"),
            this.options.cardView && a.push(e('<td colspan="%s">', this.header.fields.length)),
            !this.options.cardView && this.options.detailView && a.push("<td>", '<a class="detail-icon" href="javascript:">', e('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.detailOpen), "</a>", "</td>"),
            t.each(this.header.fields,
            function(i, h) {
                var l = "",
                c = d(f, h),
                b = "",
                m = {},
                y = "",
                v = n.header.classes[i],
                w = "",
                x = "",
                $ = "",
                k = n.columns[s(n.columns, h)];
                if (k.visible) {
                    if (u = e('style="%s"', g.concat(n.header.styles[i]).join("; ")), c = r(k, n.header.formatters[i], [c, f, p], c), f["_" + h + "_id"] && (y = e(' id="%s"', f["_" + h + "_id"])), f["_" + h + "_class"] && (v = e(' class="%s"', f["_" + h + "_class"])), f["_" + h + "_rowspan"] && (x = e(' rowspan="%s"', f["_" + h + "_rowspan"])), f["_" + h + "_title"] && ($ = e(' title="%s"', f["_" + h + "_title"])), m = r(n.header, n.header.cellStyles[i], [c, f, p], m), m.classes && (v = e(' class="%s"', m.classes)), m.css) {
                        var S = [];
                        for (var P in m.css) S.push(P + ": " + m.css[P]);
                        u = e('style="%s"', S.concat(n.header.styles[i]).join("; "))
                    }
                    f["_" + h + "_data"] && !t.isEmptyObject(f["_" + h + "_data"]) && t.each(f["_" + h + "_data"],
                    function(t, i) {
                        "index" !== t && (w += e(' data-%s="%s"', t, i))
                    }),
                    k.checkbox || k.radio ? (b = k.checkbox ? "checkbox": b, b = k.radio ? "radio": b, l = [n.options.cardView ? '<div class="card-view">': '<td class="bs-checkbox">', '<label class="' + ("checkbox" == b ? "mt-checkbox mt-checkbox-single mt-checkbox-outline": "mt-radio mt-radio-single mt-radio-outline") + '"><input' + e(' data-index="%s"', p) + e(' name="%s"', n.options.selectItemName) + e(' type="%s"', b) + e(' value="%s"', f[n.options.idField]) + e(' checked="%s"', c === !0 || c && c.checked ? "checked": void 0) + e(' disabled="%s"', !k.checkboxEnabled || c && c.disabled ? "disabled": void 0) + " /><span></span></label>", n.header.formatters[i] && "string" == typeof c ? c: "", n.options.cardView ? "</div>": "</td>"].join(""), f[n.header.stateField] = c === !0 || c && c.checked) : (c = "undefined" == typeof c || null === c ? n.options.undefinedText: c, l = n.options.cardView ? ['<div class="card-view">', n.options.showHeader ? e('<span class="title" %s>%s</span>', u, o(n.columns, "field", "title", h)) : "", e('<span class="value">%s</span>', c), "</div>"].join("") : [e("<td%s %s %s %s %s %s>", y, v, u, w, x, $), c, "</td>"].join(""), n.options.cardView && n.options.smartDisplay && "" === c && (l = '<div class="card-view"></div>')),
                    a.push(l)
                }
            }),
            this.options.cardView && a.push("</td>"),
            a.push("</tr>")
        }
        a.length || a.push('<tr class="no-records-found">', e('<td colspan="%s">%s</td>', this.$header.find("th").length, this.options.formatNoMatches()), "</tr>"),
        this.$body.html(a.join("")),
        i || this.scrollTo(0),
        this.$body.find("> tr[data-index] > td").off("click dblclick").on("click dblclick",
        function(i) {
            var o = t(this),
            a = o.parent(),
            r = n.data[a.data("index")],
            h = o[0].cellIndex,
            l = n.header.fields[n.options.detailView && !n.options.cardView ? h - 1 : h],
            p = n.columns[s(n.columns, l)],
            c = d(r, l);
            if (!o.find(".detail-icon").length && (n.trigger("click" === i.type ? "click-cell": "dbl-click-cell", l, c, r, o), n.trigger("click" === i.type ? "click-row": "dbl-click-row", r, a), "click" === i.type && n.options.clickToSelect && p.clickToSelect)) {
                var f = a.find(e('[name="%s"]', n.options.selectItemName));
                f.length && f[0].click()
            }
        }),
        ...
        function(i, e) {
            if (e) {
                ...
                for (var a in e) n.$body.find(">tr:not(.no-records-found)").each(function() {
                    var i = t(this),
    ...
    f.prototype.initServer = function(i, e) {
        var o, s = this,
        n = {},
        a = {
        ...
        r(null, this.options.ajaxOptions), {
            ...
            success: function(t) {
                t = r(s.options, s.options.responseHandler, [t], t),
                s.load(t),
                s.trigger("load-success", t)
            },
            error: function(t) {
                s.trigger("load-error", t.status, t)
            },
            complete: function() {
    ...
    f.prototype.trigger = function(i) {
        ...
        i += ".bs.table",
        this.options[f.EVENTS[i]].apply(this.options, e),
    ...
    f.prototype.resetHeader = function() {
        ...
        this.timeoutId_ = setTimeout(t.proxy(this.fitHeader, this), this.$el.is(":hidden") ? 100 : 0)
    },
    f.prototype.fitHeader = function() {
        ...
        n = t(".focus-temp:visible:eq(0)"),
        n.length > 0 && (n.focus(), this.$header.find(".focus-temp").removeClass("focus-temp")),
        this.$header.find("th[data-field]").each(function(i) {
        ...
        this.$body.find(">tr:first-child:not(.no-records-found) > *").each(function(i) {
            ...
            r.$header_.find(e('th[data-field="%s"]', c[s])).find(".fht-cell").width(o.innerWidth())
        }),
        this.$tableBody.off("scroll").on("scroll",
        function() {
            r.$tableHeader.scrollLeft(t(this).scrollLeft()),
            r.options.showFooter && !r.options.cardView && r.$tableFooter.scrollLeft(t(this).scrollLeft())
        }),
    ...
    f.prototype.resetFooter = function() {
        ...
        o = i.getData(),
        s = [];
        this.options.showFooter && !this.options.cardView && (!this.options.cardView && this.options.detailView && s.push('<td><div class="th-inner">&nbsp;</div><div class="fht-cell"></div></td>'), t.each(this.columns,
        function(t, n) {
            var a = "",
            h = "",
            l = e(' class="%s"', n["class"]);
            n.visible && (!i.options.cardView || n.cardVisible) && (a = e("text-align: %s; ", n.falign ? n.falign: n.align), h = e("vertical-align: %s; ", n.valign), s.push("<td", l, e(' style="%s"', a + h), ">"), s.push('<div class="th-inner">'), s.push(r(n, n.footerFormatter, [o], "&nbsp;") || "&nbsp;"), s.push("</div>"), s.push('<div class="fht-cell"></div>'), s.push("</div>"), s.push("</td>"))
    ...
    f.prototype.fitFooter = function() {
        ...
        this.$el.is(":hidden") ? void(this.timeoutFooter_ = setTimeout(t.proxy(this.fitFooter, this), 100)) : (e = this.$el.css("width"), o = e > this.$tableBody.width() ? a() : 0, this.$tableFooter.css({
            "margin-right": o
    ...
    f.prototype.toggleColumn = function(t, i, o) {
        if ( - 1 !== t && (this.columns[t].visible = i, this.initHeader(), this.initSearch(), this.initPagination(), this.initBody(), this.options.showColumns)) {
            ...
            o && s.filter(e('[value="%s"]', t)).prop("checked", i),
            s.filter(":checked").length <= this.options.minimumCountColumns && s.filter(":checked").prop("disabled", !0)
        }
    },
    f.prototype.toggleRow = function(t, i, o) { - 1 !== t && this.$body.find("undefined" != typeof t ? e('tr[data-index="%s"]', t) : e('tr[data-uniqueid="%s"]', i))[o ? "show": "hide"]()
    },
    f.prototype.getVisibleFields = function() {
        var i = this,
        e = [];
        return t.each(this.header.fields,
        function(t, o) {
    ...
    f.prototype.load = function(i) {
        var e = !1;
        "server" === this.options.sidePagination ? (this.options.totalRows = i.total, e = i.fixedScroll, i = i[this.options.dataField]) : t.isArray(i) || (e = i.fixedScroll, i = i.data),
        this.initData(i),
        this.initSearch(),
        this.initPagination(),
        this.initBody(e)
    ...
    f.prototype.remove = function(i) {
        ...
        if (i.hasOwnProperty("field") && i.hasOwnProperty("values")) {
            for (e = s - 1; e >= 0; e--) o = this.options.data[e],
            o.hasOwnProperty(i.field) && -1 !== t.inArray(o[i.field], i.values) && this.options.data.splice(e, 1);
    ...
    f.prototype.removeByUniqueId = function(t) {
        ...
        i !== this.options.data.length && (this.initSearch(), this.initPagination(), this.initBody(!0))
    },
    f.prototype.updateByUniqueId = function(i) {
        var e;
        i.hasOwnProperty("id") && i.hasOwnProperty("row") && (e = t.inArray(this.getRowByUniqueId(i.id), this.options.data), -1 !== e && (t.extend(this.data[e], i.row), this.initSort(), this.initBody(!0)))
    },
    ...
    f.prototype.showRow = function(t) {
        t.hasOwnProperty("index") && t.hasOwnProperty("uniqueId") && this.toggleRow(t.index, t.uniqueId, !0)
    },
    f.prototype.hideRow = function(t) {
        t.hasOwnProperty("index") && t.hasOwnProperty("uniqueId") && this.toggleRow(t.index, t.uniqueId, !1)
    },
    f.prototype.getRowsHidden = function(i) {
        var e = t(this.$body[0]).children().filter(":hidden"),
        o = 0;
        if (i) for (; o < e.length; o++) t(e[o]).show();
        return e
    },
    f.prototype.mergeCells = function(i) {
        ...
        if (this.options.detailView && !this.options.cardView && (a += 1), s = l.eq(n).find(">td").eq(a), !(0 > n || 0 > a || n >= this.data.length)) {
            for (e = n; n + r > e; e++) for (o = a; a + h > o; o++) l.eq(e).find(">td").eq(o).hide();
            s.attr("rowspan", r).attr("colspan", h).show()
        }
    },
    f.prototype.updateCell = function(t) {
        t.hasOwnProperty("index") && t.hasOwnProperty("field") && t.hasOwnProperty("value") && (this.data[t.index][t.field] = t.value, this.initSort(), this.initBody(!0))
    },
    ...
    f.prototype.getAllSelections = function() {
        var i = this;
        return t.grep(this.options.data,
        function(t) {
            return t[i.header.stateField]
        })
    },
    ...
    f.prototype.check_ = function(t, i) {
        ...
        this.updateSelected(),
        this.trigger(t ? "check": "uncheck", this.data[i], o)
    },
        ...
        if (o.hasOwnProperty("field") && o.hasOwnProperty("values")) {
            ...
            function(a, r) {
                ...
                if ( - 1 !== t.inArray(r[o.field], o.values)) {
                    ...
                    r[s.header.stateField] = i,
                    n.push(r),
                    s.trigger(i ? "check": "uncheck", r, h)
                }
            }),
            this.updateSelected(),
    ...
    f.prototype.togglePagination = function() {
        ...
        this.options.pagination ? t.attr("class", this.options.iconsPrefix + " " + this.options.icons.paginationSwitchDown) : t.attr("class", this.options.iconsPrefix + " " + this.options.icons.paginationSwitchUp),
        this.updatePagination()
    },
    f.prototype.refresh = function(t) {
        t && t.url && (this.options.url = t.url, this.options.pageNumber = 1),
        this.initServer(t && t.silent, t && t.query)
    },
    ...
    f.prototype.scrollTo = function(t) {
        return "string" == typeof t && (t = "bottom" === t ? this.$tableBody[0].scrollHeight: 0),
        "number" == typeof t && this.$tableBody.scrollTop(t),
        "undefined" == typeof t ? this.$tableBody.scrollTop() : void 0
    },
        ...
        if (i) {
            ...
            if (o.next().is("tr.detail-view") ? o.next().next().is("tr.detail-view") || (o.next().find(".detail-icon").click(), a = !0) : (o.find("> td > .detail-icon").click(), a = !0), a) try {
                r = setInterval(function() {
                    n = s.$body.find("tr.detail-view").last().find(".detail-icon"),
                    n.length > 0 ? n.click() : clearInterval(r)
                },
                1)
            } catch(h) {
                clearInterval(r)
            }
        } else for (var l = this.$body.children(), p = 0; p < l.length; p++) this.expandRow_(!0, t(l[p]).data("index"))
    },
    f.prototype.collapseAllRows = function(i) {
        if (i) this.expandRow_(!1, 0);
        else for (var e = this.$body.children(), o = 0; o < e.length; o++) this.expandRow_(!1, t(e[o]).data("index"))
    };
    ...
    t.fn.bootstrapTable = function(i) {
        ...
        return this.each(function() {
            ...
            a = t.extend({},
            f.DEFAULTS, s.data(), "object" == typeof i && i);
            if ("string" == typeof i) {
                if (t.inArray(i, u) < 0) throw new Error("Unknown method: " + i);
                if (!n) return;
                e = n[i].apply(n, o),
    ...
    t.fn.bootstrapTable.Constructor = f,
    t.fn.bootstrapTable.defaults = f.DEFAULTS,
    t.fn.bootstrapTable.columnDefaults = f.COLUMN_DEFAULTS,
    t.fn.bootstrapTable.locales = f.LOCALES,
    t.fn.bootstrapTable.methods = u,
