function imageUp(id,parents){
	...
	if (parents) var bt = $("#"+id).parents(parents).next().find('.image_group'), str = "";
	else var bt = $("#"+id).parent().next('.image_group'), str = "";
...
function videoUp(id,parents){
	...
	if (parents) var bt = $("#"+id).parents(parents).prev().find('.image_group'), str = "";
	else var bt = $("#"+id).parent().prev('input'), str = "";
	function uploadSuccess(file, data){
		if (data)
		{
			bt.val(dir_url+data);
